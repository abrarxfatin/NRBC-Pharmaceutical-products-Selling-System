...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="GET" action="{{ route('purchases.generatePDFReport') }}" class="d-inline mb-3">
                        ...
                        <table id="purchase-table" class="datatable table table-hover table-center mb-0">
                            ...
                            @foreach ($purchases as $purchase)
                                ...
                                <tr>
                                    ...
                                    <td>{{ AppSettings::get('app_currency', 'BDT') }}{{$purchase->price}}</td>
...
<script>
    $(document).ready(function() {
        $('#purchase-table').DataTable(); // Removed export buttons
    });
</script>
@endpush
