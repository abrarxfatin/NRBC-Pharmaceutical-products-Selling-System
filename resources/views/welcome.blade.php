...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>NRBC Pharmacy Shop</title>
        <!-- Favicon -->
    ...
    <body class="antialiased">
        ...
        style="background-image: url('images/main.jpg'); background-size: cover; background-position: center;">
            @if (Route::has('login'))
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="content-box">
                    <h2>
                        <img src="{{ asset('assets/img/pharrrlg.png') }}" alt="NRBC Pharmacy Shop Logo" class="logo">
                        <span style="color: rgb(2, 61, 2);">NRBC</span>
                        <span style="color: rgb(60, 202, 60);">Pharmacy Shop</span>
                    </h2>
                </div>


                <div class="flex justify-center mt-4 sm:items-center sm:justify-between content-box">
