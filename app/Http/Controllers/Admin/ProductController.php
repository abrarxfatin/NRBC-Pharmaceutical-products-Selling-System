    ...
    public function expired(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($products)
                ...
                ->addColumn('category', function ($product) {
                    return optional($product->category)->name ?? 'N/A'; // Use optional for safety
                })
                ->addColumn('price', function ($product) {
                    return settings('app_currency', 'BDT') . ' ' . $product->cost_price;
                })
                ->addColumn('quantity', function ($product) {
                    return $product->quantity; // Display the quantity
                })
                ->addColumn('expiry_date', function ($product) {
                    return optional($product->expiry_date) ? date_format(date_create($product->expiry_date), 'd M, Y') : 'N/A'; // Use optional for safety
                })
    ...
    public function outstock(Request $request)
    {
        ...
        if($request->ajax()) {
            ...
            return DataTables::of($products)
                ...
                ->addColumn('expiry_date', function($product) {
                    return $product->expiry_date ? date_format(date_create($product->expiry_date), 'd M, Y') : 'N/A';
                })
