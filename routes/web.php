...
Route::middleware(['auth'])->prefix('admin')->group(function(){
    ...
    Route::get('purchases/generate-pdf-report', [PurchaseController::class, 'generatePDFReport'])->name('purchases.generatePDFReport');
    ...
    Route::get('sales/generatePDFReport', [SaleController::class, 'generatePDFReport'])->name('sales.generatePDFReport');
    Route::get('sales/receipt', [SaleController::class, 'showReceipt'])->name('sales.receipt');
    Route::get('sales/receipt/{pdfName}', [SaleController::class, 'downloadReceipt'])->name('sales.receipt.download');
    ...
    Route::get('admin/users/approve/{id}', [UserController::class, 'approveUser'])->name('admin.users.approve');
...
Route::middleware(['auth', 'approved'])->group(function () {
    // All routes that require user approval
    Route::get('dashboard', [DashboardController::class, 'index'])->name('dashboard');
});
